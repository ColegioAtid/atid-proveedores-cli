...
export default {
  ...
  computed: {
    ...
    setFilesToUpdate: function(){      
      return this.arrayFiles.filter((e)=>e.tipoPersona.includes(this.getDataProveedor().tipo_persona))
    }
  },
  methods: {
    /** VUEX */
    ...
    async updateFiles() {
      ...
      try {
        let file = {
          filename: this.selectInput.filename,
